...
public class TrainingController {
	...
	public ResponseEntity<List<TrainingDetailsDTO>> getTrainings() throws RestClientException {
	...
	public ResponseEntity<TrainingDetailsDTO> getTraining(@PathVariable Integer empId) throws RestClientException, EmployeeServiceException {
		TrainingDetailsDTO training = trainingService.getTrainingDetail(empId);
		return new ResponseEntity<>(training, HttpStatus.OK);
	}

	@PostMapping(value = "/Training")
	public ResponseEntity<String> addTraining(@RequestBody TrainingDetailsDTO training) throws RestClientException, EmployeeServiceException {
	...
	public ResponseEntity<String> deleteTraining(@PathVariable Integer empId) throws RestClientException, EmployeeServiceException {
